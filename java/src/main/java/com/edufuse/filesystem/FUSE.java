...
import com.edufuse.struct.Flock;
import com.edufuse.struct.FuseBufvec;
import com.edufuse.struct.FuseFileInfo;
import com.edufuse.struct.FusePollhandle;
import com.edufuse.struct.Statvfs;
import com.edufuse.struct.Timespec;
...
public interface FUSE {
     ...
     *             is created. @see com.edufuse.struct.FileStat flags
     */
     ...
     * is SIZE bytes long).
     *
     * @param flags @see {@link com.edufuse.flags.XAttrConstants}
     ...
     *
     * @param mask see @{link com.edufuse.flags.AccessConstants}
     ...
     *
     * @param flags See {@link com.edufuse.flags.IoctlFlags}
     */
     ...
     * interesting for network filesystems and similar.
     *
     * @param op see {@link com.edufuse.struct.Flock}
     */
